...
$player_username = $_GET['coach_username'];
...
if(trim($_GET['coach_username']) == "" ){
    ...
    if (!empty($player_username && $name )) {
        ...
        $query = "INSERT INTO `notifications` (`id`, `name`, `type`, `message`, `status`, `date`) VALUES (NULL, '$player_username', 'comment', '  a new  payment has been added to your account', 'unread', CURRENT_TIMESTAMP)";
    }
                ...
                <form action='' method='post' enctype='multipart/form-data'>
                    <div class='field-wrap'>
                        <label > <font color='#FF0000'>  </font><br>
                            ...
                            <input type='text' required autocomplete='on' name='sus'  maxlength='40' placeholder="KSH " />
                    </div>
                    ...
                    <a href='http://localhost/kaesa/login/a-module/assets/API/pay_a_coach.php?coach_username=$player_username'><button id="button" class='button' onclick="return confirmDelete(id,'<?php echo $player_username ;?>');">send</button></a>
                    <?php
